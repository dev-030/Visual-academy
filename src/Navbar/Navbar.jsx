       ...
       <div className="font-dosis">
            <div className="navbar bg-[#23445b] text-white">
                <div className="navbar-start">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-[#23445b] rounded-box w-52">
                        <li><NavLink to={'/'} className={''}>Home</NavLink></li>
                        <li><NavLink to={'/instructors'} className={''}>Instructors</NavLink></li>
                    ...
                    <a className="btn btn-ghost normal-case text-3xl md:ml-10 ml-[-25px]" href="/">Visual Academy</a>
                </div>
